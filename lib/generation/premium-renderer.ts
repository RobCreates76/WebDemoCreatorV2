...
import { getPremiumCss } from "@/lib/generation/template-css";
...
export function renderPremiumSiteHtml(
  ...
  if (enabled.has("services")) {
    ...
    <section class="section" id="services">
      <div class="container">
        ${sectionHeader("What We Offer", site.services.headline, "services", "headline", editMode, "Expert solutions tailored to your goals — delivered with care and precision.")}
  ...
  if (enabled.has("why-us")) {
    ...
    <section class="section" id="why-us" style="background:var(--color-bg)">
      <div class="container">
        ${sectionHeader("Why Choose Us", site.whyUs.headline, "whyUs", "headline", editMode, "The difference shows in every detail — from first contact to final result.")}
        <div class="why-grid">
          ${site.whyUs.items
            .map(
              (w, i) => `
  ...
  if (enabled.has("gallery")) {
    ...
    <section class="section" id="gallery">
      <div class="container">
        ${sectionHeader("Portfolio", site.gallery.headline, "gallery", "headline", editMode, "A look at the quality and craft behind every project.")}
  ...
  if (enabled.has("testimonials")) {
    ...
    <section class="section" id="testimonials" style="background:var(--color-surface)">
      <div class="container">
        ${sectionHeader("Client Stories", site.testimonials.headline, "testimonials", "headline", editMode, "Real feedback from people who chose us — and came back again.")}
  ...
  if (enabled.has("faq")) {
    ...
    <section class="section" id="faq">
      <div class="container">
        ${sectionHeader("Questions", site.faq.headline, "faq", "headline", editMode, "Everything you need to know before getting started.")}
        <div class="faq-list">
          ${site.faq.items
            .map(
              (f, i) => `
  ...
  if (enabled.has("contact")) {
    ...
    <section class="section contact-section" id="contact">
      <div class="container contact-grid">
        ...
        <form class="contact-form reveal" style="--delay: 2" onsubmit="event.preventDefault(); alert('Demo form — connect to your backend');">
